	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("input[name=tamanio]:radio" ).change(function(){
				...
				if (valor == 1) {
					costo1 = 300;
					$("#tamanio_v").val("100x70cm");
				}else{
					costo1 = 500;
					$("#tamanio_v").val("50x70cm");
				}
				actualizar();
			});
...
<div class="container-fluid cuerpo">
	...
	<div class="contenedor-impresion-1 col-xs-12 col-sm-12 col-md-12">
		...
		<div class="contenedor-texto-seccion col-xs-4 col-sm-3 col-md-3">
			<label class="texto-secciong">Afiches:</label>
			<label class="texto-secciong1">Pliego - 1/2 pliego</label>
		</div>
	</div>
	...
	<div class="container">
		<div class="row contenedor-medio">
			<div class="col-xs-12 col-sm-3 col-md-3"><center><div class="opcion-img"><img  src="../images/impresion-d-2.jpg"></div></center></div>
			<form action="agregar_imprime_carrito.php" onsubmit="return validarForm();">
			<input type="hidden" name="id-seccion" value="2">
			<div class="col-xs-12 col-sm-6 col-md-6"><div class="show"><br><br><br><br></div>
				<div class="contenedor-especificaciones col-xs-12">
					...
					<label class="radio-inline"><input type="radio" id="tamanio" name="tamanio" value="1">100x70cm</label>
					<label class="radio-inline"><input type="radio" id="tamanio1" name="tamanio" value="2">50x70cm</label>
