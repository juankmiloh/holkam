...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			function actualizar(){
				sumando = basico + costo1 + costo2 + costo3 + costo4 + costo5;
				var uni = new Array();
				var valor;
				for (var i = 0; i <= 5; i++) {
			...
			$("input[name=lomo]:radio" ).change(function(){
...
<div class="container-fluid cuerpo">
	...
	<div class="contenedor-impresion-1 col-xs-12 col-sm-12 col-md-12">
		...
		<div class="contenedor-texto-seccion col-xs-4 col-sm-3 col-md-3">
			<label class="texto-seccion">Carpetas </label>
			<label class="texto-seccion1">corporativas</label>
		</div>
	</div>
		...
		<div class="row contenedor-medio">
			...
			<div class="col-xs-12 col-sm-6 col-md-6"><div class="show"><br><br><br><br></div>
				<div class="contenedor-especificaciones col-xs-12">
					...
					<div class="radio">
						<label class="radio-inline"><input type="radio" id="acabado1" name="acabado" value="1">Brillo UV total</label>
				...
				<center>
					...
					<br>
						...
						<table class="table table-striped tabla">
							...
							<tr>
								<td>
									<label id="valorUnidad2" class="radio-inline"><input type="radio" id="unidades2" name="unidades" value="5">5 </label><label>&nbsp; uds</label>
								</td>
								<td>
							...
							<tr>
								<td>
									<label id="valorUnidad3" class="radio-inline"><input type="radio" id="unidades3" name="unidades" value="10">10 </label><label>&nbsp; uds</label>
								</td>
								<td>
							...
							<tr>
								<td>
									<label id="valorUnidad6" class="radio-inline"><input type="radio" id="unidades6" name="unidades" value="500">500 </label><label>&nbsp; uds</label>
								</td>
								<td>
