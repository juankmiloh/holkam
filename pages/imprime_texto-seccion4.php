...
<div class="container-fluid cuerpo">
	...
	<div class="container">
		<div class="row contenedor-medio">
			<div class="hide opcion-img col-xs-12 col-sm-3 col-md-3"><br><br><br><center><img src="../images/impresion-d-4.jpg"></center></div>
				...
				<center>
					...
					<br>
						...
						<table class="table table-striped tabla">
							...
							<tr>
								<td>
									<label id="valorUnidad6" class="radio-inline"><input type="radio" id="unidades6" name="unidades" value="6">500 </label><label>&nbsp; uds</label>
								</td>
								<td>
